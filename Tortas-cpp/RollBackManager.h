...
namespace godot
{
    ...
    struct InputState : public Object
    {
        ...
        // Copy constructor
        InputState(const InputState& other) : localInputs(other.localInputs) {}

        // Move constructor
        InputState(InputState&& other) noexcept : localInputs(std::move(other.localInputs)){}
